...
from feeder import Feeder_skating
...
def gendata(
    ...
    fp = open_memmap(
        ...
        shape=(3, max_frame, joins_count, num_person_out))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='skateboard/Tricks_openpose_result')
    parser.add_argument(
        '--out_folder', default='skateboard/Tricks_openpose_result/skeleton_file')
